...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-md-8">
                            <div class="topbar-info d-flex flex-wrap">
                                <a href="#" class="text-light me-4"><i class="fas fa-envelope text-white me-2"></i>ternakpro99@gmail.com</a>
                                <a href="#" class="text-light"><i class="fas fa-phone-alt text-white me-2"></i>+62 813-1884-8487</a>
                            </div>
                        </div>
                        <div class="col-md-4">
                ...
                <nav class="navbar navbar-light bg-light navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-light" id="navbarCollapse">
                        ...
                        <div class="d-flex align-items-center flex-nowrap pt-xl-0" style="margin-left: 15px;">
                            <a href="{{ '/home' }}" class="btn-hover-bg btn btn-primary text-white py-2 px-4 me-3">
                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption">
                            <div class="p-3" style="max-width: 900px;">
                                <h4 class="text-white text-uppercase fw-bold mb-4" style="letter-spacing: 3px;">TernakPro</h4>
                                ...
                                <div class="d-flex align-items-center justify-content-center">
                                    <a class="btn-hover-bg btn btn-primary text-white py-3 px-5" href="#about">Bergabung Bersama Kami</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption">
                            <div class="p-3" style="max-width: 900px;">
                                ...
                                <p class="mb-5 fs-5">Kami memberikan layanan terbaik untuk peternakan kambing dan domba Anda.</p>
                                <div class="d-flex align-items-center justify-content-center">
                                    <a class="btn-hover-bg btn btn-primary text-white py-3 px-5" href="#about">Pelajari Lebih Lanjut</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption">
                            <div class="p-3" style="max-width: 900px;">
                                ...
                                <p class="mb-5 fs-5">Kami menjamin kualitas ternak kambing dan domba yang sehat dan unggul untuk kebutuhan Anda.</p>
                                <div class="d-flex align-items-center justify-content-center">
                                    <a class="btn-hover-bg btn btn-primary text-white py-3 px-5" href="#about">Hubungi Kami</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-xl-7">
                        ...
                        <p class="fs-5 mb-4">TernakPro adalah spesialis peternakan domba yang bereputasi dan berpengalaman, berdedikasi untuk menyediakan domba berkualitas tinggi dengan harga bersaing. Fokus utama kami terletak pada perdagangan dan pemeliharaan domba.</p>
                        <p class="fs-5 mb-4">Kami telah mengembangkan sistem yang komprehensif untuk menyederhanakan proses, memastikan bahwa Anda dapat mengelolanya semudah menarik uang dari rekening bank Anda.</p>
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex">
                                                <div class="text-start my-auto">
                                                    ...
                                                    <p class="mb-4">TernakPro adalah spesialis peternakan domba yang bereputasi dan berpengalaman, berdedikasi untuk menyediakan domba berkualitas tinggi dengan harga bersaing. Fokus utama kami terletak pada perdagangan dan pemeliharaan domba.</p>
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex">
                                                <div class="text-start my-auto">
                                                    ...
                                                    <p class="mb-4">ernakPro berkomitmen untuk menjadi platform terdepan dalam jual beli dan pemeliharaan kambing dan domba, 
                                                        dengan menyediakan hewan berkualitas tinggi serta layanan terbaik. Kami bertujuan untuk mendukung peternak lokal dan memperluas jangkauan pasar, 
                                                        sambil memastikan transparansi dan kepuasan pelanggan melalui sistem yang efisien dan mudah diakses.</p>
                                                    <div class="d-flex align-items-center justify-content-start">
                                                        <a class="btn-hover-bg btn btn-primary text-white py-2 px-4" href="#">Selengkapnya</a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex">
                                                <div class="text-start my-auto">
                                                    ...
                                                    <p class="mb-4">Di TernakPro, misi kami adalah menyederhanakan dan memodernisasi proses perdagangan serta pemeliharaan kambing dan domba 
                                                        dengan harga bersaing dan layanan yang andal. Dengan pengalaman dan dedikasi kami, kami berupaya untuk menawarkan produk unggulan 
                                                        serta solusi yang memudahkan peternak dan pembeli dalam setiap langkah. Berdasarkan peternakan kami yang berlokasi di Desa X, Kelurahan Y, Kecamatan Z, Bogor, Jawa Barat, 
                                                        kami berkomitmen untuk memberikan pelayanan terbaik dan mendukung pertumbuhan sektor peternakan di seluruh Indonesia.
                                                    </p>
                                                    <div class="d-flex align-items-center justify-content-start">
                                                        <a class="btn-hover-bg btn btn-primary text-white py-2 px-4" href="#">Selengkapnya</a>
                                                    </div>
                ...
                <div class="container">
                    <div class="row gy-4">
                        ...
                        <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
                            <div class="service-item position-relative p-4 border rounded shadow-sm" style="background-color: #f8f9fa;">
                                <div class="icon mb-3">
                        ...
                        <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="200">
                            <div class="service-item position-relative p-4 border rounded shadow-sm" style="background-color: #f8f9fa;">
                                ...
                                <p>
                                    Membeli kambing dan domba dengan harga bersaing dan proses yang mudah.
                                </p>
                            </div>
                        </div>
                        <!-- End Service Item -->
                        ...
                        <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="300">
                            <div class="service-item position-relative p-4 border rounded shadow-sm" style="background-color: #f8f9fa;">
                                ...
                                <p>
                                    Layanan pemeliharaan kambing dan domba untuk memastikan kesehatan dan pertumbuhan yang optimal.
                                </p>
                            </div>
                        </div>
                        <!-- End Service Item -->
        ...
        <div class="container-fluid causes py-5">
            <section id="howto" class="howto text-center">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="howto-card border p-3">
                            <img src="{{ asset('landing/img/pilih-hewan.png') }}" alt="Pilih Hewan" class="howto-card-img"/>
                            <h3 class="howto-card-title">02. Pilih Hewan Ternak</h3>
                            <p class="howto-card-explain">Pilih kambing/domba dan masukkan besaran uang yang ingin dibayarkan.</p>
                        </div>
                    </div>
                    <div class="col-md-4 mb-4">
                        <div class="howto-card border p-3">
                            ...
                            <p class="howto-card-explain">Lakukan pembayaran segera melalui metode pembayaran yang Anda pilih.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center mt-4">
                    <div class="col-md-4 mb-4">
                        <div class="howto-card border p-3">
                            <img src="{{ asset('landing/img/konfirmasi-pembayaran.png') }}" alt="Konfirmasi Pembayaran" class="howto-card-img"/>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="howto-card border p-3">
                            <img src="{{ asset('landing/img/pantau-ternak.png') }}" alt="Pantau Ternak" class="howto-card-img"/>
                            ...
                            <div class="col-md-4 mb-4 d-flex justify-content-center">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0">Perumahan Bukit Waringin Blok I 1 No.27 RT 006/014, Kecamatan Bojonggede, Kabupaten Bogor</p>
                                    </div>
                                </div>
                            </div>
                            <!-- End Info Item -->
        ...
        <!-- feedback Start -->
        <div class="container-fluid gallery py-5 px-0" id="feedback">
                ...
                <div class="card mx-auto" style="max-width: 80%;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="feedback-list">
                            @foreach ($data_awal as $awal)
                                <div class="feedback-item">
                                    <div class="feedback-header">
                                        <strong>{{ $awal->nama_lengkap }}</strong>
                                    </div>
                                    ...
                                    <div class="feedback-actions">
                                        ...
                                        <a href="{{ route('awal.show', $awal->id) }}" class="btn btn-success btn-sm">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('awal.edit', $awal->id) }}" class="btn btn-warning btn-sm">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('awal.destroy', $awal->id) }}" method="POST" style="display:inline;" class="delete-form">
                                            @csrf
                                            @method('DELETE')
                        ...
                        <div class="text mt-3">
                            <a href="{{ route('awal.create') }}" class="btn btn-primary">
                                <i class="fas fa-user-plus"></i> Form Pengisian Feedback
                            </a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row g-2">
                                <div class="col-4">
                                    <div class="footer-gallery">
                                        <img src="{{ asset('landing/img/foto-1.jpeg') }}" class="img-fluid w-100" alt="" style="height: 150px; object-fit: cover;">
                                        <div class="footer-search-icon">
                                            <a href="{{ asset('landing/img/foto-1.jpeg') }}" data-lightbox="footerGallery-1" class="my-auto"><i class="fas fa-search-plus text-white"></i></a>
                                        </div>
                                    </div>
                               </div>
                               <div class="col-4">
                                    <div class="footer-gallery">
                                        <img src="{{ asset('landing/img/foto-2.jpeg') }}" class="img-fluid w-100" alt="" style="height: 150px; object-fit: cover;">
                                        <div class="footer-search-icon">
                                            <a href="{{ asset('landing/img/foto-2.jpeg') }}" data-lightbox="footerGallery-2" class="my-auto"><i class="fas fa-search-plus text-white"></i></a>
                                        </div>
                                    </div>
                               </div>
                                <div class="col-4">
                                    <div class="footer-gallery">
                                        <img src="{{ asset('landing/img/foto-3.jpeg') }}" class="img-fluid w-100" alt="" style="height: 150px; object-fit: cover;">
                                        <div class="footer-search-icon">
                                            <a href="{{ asset('landing/img/foto-3.jpeg') }}" data-lightbox="footerGallery-3" class="my-auto"><i class="fas fa-search-plus text-white"></i></a>
                                        </div>
                                    </div>
                               </div>
                                <div class="col-4">
                                    <div class="footer-gallery">
                                        <img src="{{ asset('landing/img/foto-4.jpg') }}" class="img-fluid w-100" alt="" style="height: 150px; object-fit: cover;">
                                        <div class="footer-search-icon">
                                            <a href="{{ asset('landing/img/foto-4.jpg') }}" data-lightbox="footerGallery-4" class="my-auto"><i class="fas fa-search-plus text-white"></i></a>
                                        </div>
                                    </div>
                               </div>
                                <div class="col-4">
                                    <div class="footer-gallery">
                                        <img src="{{ asset('landing/img/foto-5.jpeg') }}" class="img-fluid w-100" alt="" style="height: 150px; object-fit: cover;">
                                        <div class="footer-search-icon">
                                            <a href="{{ asset('landing/img/foto-5.jpeg') }}" data-lightbox="footerGallery-5" class="my-auto"><i class="fas fa-search-plus text-white"></i></a>
                                        </div>
                                    </div>
                               </div>
                               <div class="col-4">
                                    <div class="footer-gallery">
                                        <img src="{{ asset('landing/img/foto-6.jpg') }}" class="img-fluid w-100" alt="" style="height: 150px; object-fit: cover;">
                                        <div class="footer-search-icon">
                                            <a href="{{ asset('landing/img/foto-6.jpg') }}" data-lightbox="footerGallery-6" class="my-auto"><i class="fas fa-search-plus text-white"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
